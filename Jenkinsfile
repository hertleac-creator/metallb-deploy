pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/hertleac-creator/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('hertleac-225')   // <---- Change this to match your kubernetes cluster credentials
    }
